...
public class BusTicketing extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBoxDestination.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select Destination ", "Hyderabad", "vijayawada", "goa", "kasool", "araku", "vizag" }));
    ...
    private void jButtonTotalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonTotalActionPerformed
       ...
       if(jComboBoxDestination.getSelectedItem().equals("Hyderabad") && jRadioButtonFirstClass1.isSelected()&& 
       ...
       jTextFieldDate2.setText(jDateChooser.getDate().toString());
         jTextFieldForm.setText("Banglore");
       ...
       else if(jComboBoxDestination.getSelectedItem().equals("vijayawada")&& jRadioButtonEconomy1.isSelected()&& 
               jRadioButtonSingle1.isSelected()&& (!(jTextFieldPassenger1.getText()== null) )){
     int Pass = Integer.parseInt(jTextFieldPassenger1.getText());
     
      jTextFieldPassengers2.setText(jTextFieldPassenger1.getText());
         jTextFieldTo.setText("vijayawada");
       jTextFieldClass.setText("Economy");
       jTextFieldTicketType.setText("One Way");       
       jTextFieldDate2.setText(jDateChooser.getDate().toString());
         jTextFieldForm.setText("Banglore");
       ...
       else if(jComboBoxDestination.getSelectedItem().equals("vijayawada") && jRadioButtonFirstClass1.isSelected() && 
               jRadioButtonSingle1.isSelected()&& (!(jTextFieldPassenger1.getText()== null) ) ){
           int Pass = Integer.parseInt(jTextFieldPassenger1.getText());
      ...
      jTextFieldDate2.setText(jDateChooser.getDate().toString());
       ...
       else if(jComboBoxDestination.getSelectedItem().equals("goa") && jRadioButtonEconomy1.isSelected() 
               && jRadioButtonReturn1.isSelected()&& (!(jTextFieldPassenger1.getText()== null) )){
       int Pass = Integer.parseInt(jTextFieldPassenger1.getText());
      
       jTextFieldPassengers2.setText(jTextFieldPassenger1.getText());
         jTextFieldTo.setText("goa");
       jTextFieldClass.setText("Economy");
       jTextFieldTicketType.setText("Round Trip");
       jTextFieldDate2.setText(jDateChooser.getDate().toString());
         jTextFieldForm.setText("Banglore");
       ...
       jTextFieldTicketType.setText(null);
           ...
           else if(jComboBoxDestination.getSelectedItem().equals("goa") && jRadioButtonFirstClass1.isSelected()
                   && jRadioButtonReturn1.isSelected() && (!(jTextFieldPassenger1.getText()== null) )){
          int Pass = Integer.parseInt(jTextFieldPassenger1.getText());
   ...
   if(jComboBoxTime.getSelectedItem().equals("11:30")){
      ...
      int Pass = Integer.parseInt(jTextFieldPassenger1.getText());
       ...
       else if(jComboBoxDestination.getSelectedItem().equals("kasool")&& jRadioButtonEconomy1.isSelected()
               && jRadioButtonSingle1.isSelected()&& (!(jTextFieldPassenger1.getText()== null) )){
       int Pass = Integer.parseInt(jTextFieldPassenger1.getText());
   
       jTextFieldPassengers2.setText(jTextFieldPassenger1.getText());
         jTextFieldTo.setText("kasool");
       jTextFieldClass.setText("Economy");
       jTextFieldTicketType.setText("One Way");
       jTextFieldDate2.setText(jDateChooser.getDate().toString());
         jTextFieldForm.setText("Banglore");
       ...
       jTextFieldTicketType.setText(null);
          ...
          else if(jComboBoxDestination.getSelectedItem().equals("kasool") && jRadioButtonFirstClass1.isSelected()
                  && jRadioButtonReturn1.isSelected()&& (!(jTextFieldPassenger1.getText()== null) ) ){
         int Pass = Integer.parseInt(jTextFieldPassenger1.getText());
       ...
       jTextFieldTicketType.setText(null);
          ...
          else if(jComboBoxDestination.getSelectedItem().equals("araku")&& jRadioButtonEconomy1.isSelected()
               && jRadioButtonSingle1.isSelected()&& (!(jTextFieldPassenger1.getText()== null) )){
      int Pass = Integer.parseInt(jTextFieldPassenger1.getText());
     
       jTextFieldPassengers2.setText(jTextFieldPassenger1.getText());
         jTextFieldTo.setText("araku");
       jTextFieldClass.setText("Economy");
       jTextFieldTicketType.setText("One Way");
       jTextFieldDate2.setText(jDateChooser.getDate().toString());
         jTextFieldForm.setText("Banglore");
      ...
      int Pass = Integer.parseInt(jTextFieldPassenger1.getText());
       ...
       else if(jComboBoxDestination.getSelectedItem().equals("araku") && jRadioButtonFirstClass1.isSelected()
               && jRadioButtonReturn1.isSelected() && (!(jTextFieldPassenger1.getText()== null) )){           
         int Pass = Integer.parseInt(jTextFieldPassenger1.getText());
